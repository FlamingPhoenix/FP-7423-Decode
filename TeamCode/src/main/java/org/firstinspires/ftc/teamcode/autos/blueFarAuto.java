...
@Autonomous(name = "Blue Auto Far NEW", group = "Autonomous")
@Configurable
public class blueFarAuto extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(144 - 81.191, 8.973, Math.toRadians(180 - 90)));
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower.pathBuilder()
                .addPath(
                    new BezierLine(
                        new Pose(144 - 81.191, 8.973),
                        new Pose(144 - 84.012, 22.650)
                    )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180 - 90), Math.toRadians(180 - 66))
                .build();
            ...
            Path2 = follower.pathBuilder()
                .addPath(
                    new BezierLine(
                        new Pose(144 - 84.012, 22.650),
                        new Pose(144 - 97.882, 36.000)
                    )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180 - 66), Math.toRadians(180 - 0))
                .build();
            ...
            Path4 = follower.pathBuilder()
                .addPath(
                    new BezierLine(
                        new Pose(144 - 131.469, 36.000),
                        new Pose(144 - 83.687, 22.760)
                    )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180 - 0), Math.toRadians(180 - 66))
                .build();
            ...
            Path5 = follower.pathBuilder()
                .addPath(
                    new BezierCurve(
                        new Pose(144 - 83.687, 22.760),
                        new Pose(144 - 105.876, 21.382),
                        new Pose(144 - 123.293, 10.000)
                    )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180 - 66), Math.toRadians(180 - 0))
                .build();
